...
?>
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR DATOS DE USUARIO
				</h3>
			</div>
			<!-- Content here-->
                         ...
                         <?php } ?>
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9()+]{1,20}" class="form-control" name="cliente_telefono" id="cliente_telefono" maxlength="20" value="<?php echo $row["telefono"]; ?>">
                  ...
                  if ($_GET["cliente_dni"]&&$_GET["cliente_nombre"]&&$_GET["usuario_clave"]&&$_GET["cliente_telefono"]&&$_GET["item_dependencia"]) {
                      ...
                      echo"<script>
                            swal({ title: '¡Excelente!',
                                  ...
                                  if (okay) {
                                  window.location.href = 'actualizar-usuario-coordinador-mantenimiento.php?id=$_GET[cliente_dni]';
                                  }
                            });
                           </script>";

                  }else if(isset($_GET["actualizar_usuario_cm"])){
          ...
          ?>
					...
					<p class="text-center" style="margin-top: 40px;">
						<button type="submit" class="btn btn-raised btn-success btn-sm" name="actualizar_usuario_cm"><i class="fas fa-sync-alt"></i> &nbsp; ACTUALIZAR</button>
					</p>
				</form>
			</div>
