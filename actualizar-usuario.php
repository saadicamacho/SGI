...
?>
                  ...
                  if ($_GET["cliente_dni"]&&$_GET["cliente_nombre"]&&$_GET["usuario_clave"]&&$_GET["cliente_telefono"]&&$_GET["item_dependencia"]) {
                      ...
                      echo"<script>
                            swal({ title: '¡Excelente!',
                                  ...
                                  if (okay) {
                                  window.location.href = 'actualizar-usuario.php?id=$_GET[cliente_dni]';
                                  }
                            });
                           </script>";
                  }else if(isset($_GET["actualizar_usuario"])){
          ...
          ?>
					...
					<p class="text-center" style="margin-top: 40px;">
						<button type="submit" class="btn btn-raised btn-success btn-sm" name="actualizar_usuario"><i class="fas fa-sync-alt"></i> &nbsp; ACTUALIZAR</button>
					</p>
				</form>
			</div>
