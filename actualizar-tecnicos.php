...
?>
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-sync-alt fa-fw"></i> &nbsp; ACTUALIZAR TÉCNICOS
				</h3>
			</div>
			<!-- Content here-->
                    ...
                    <small id="emailHelp" class="form-text text-muted">Máximo 10 caracteres entre letras y números.</small>
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="email" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" class="form-control" id="cliente_correo" maxlength="150" placeholder="usuario@ejemplo.com" value="<?php echo $row["correo"]; ?>">
									</div>
								</div>
							</div>
						</div>
                  ...
                  if ($_GET["cliente_dni"]&&$_GET["cliente_nombre"]&&$_GET["usuario_clave"]) {
                      ...
                      echo"<script>
                            swal({ title: '¡Excelente!',
                                  ...
                                  if (okay) {
                                  window.location.href = 'actualizar-tecnicos.php?id=$_GET[cliente_dni]';
                                  }
                            });
                           </script>";
